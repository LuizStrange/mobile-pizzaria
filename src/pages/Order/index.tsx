    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.qtdContainer}>
                ...
                <TextInput style={[styles.input, { width: '60%', textAlign: 'center'}]} placeholder={amount} placeholderTextColor="#FFF" keyboardType="numeric" onChangeText={setAmount}/>
            </View>
            ...
            <Modal transparent={true} visible={modalProductVisible} animationType="fade">
                <ModalPicker handleCloseModal={() => setModalProductVisible(false)} options={products} selectedItem={handleChangeProducts}/>
            </Modal>
        </View>
    )
}
